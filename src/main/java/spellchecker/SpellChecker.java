...
//        }
//    }
    public static Hashtable getW_LM() {
        return W_LM;
    }

    public static void setW_LM(Hashtable W_LM) {
        SpellChecker.W_LM = W_LM;
    }

    public static Hashtable getT_LM() {
        return T_LM;
    }

    public static void setT_LM(Hashtable T_LM) {
        SpellChecker.T_LM = T_LM;
    }
}
